...
const userFriends = (_a = users.find(user => user.id === "99cad7dd-8a84-5b22-a84e-daf649b202b7")) === null || _a === void 0 ? void 0 : _a.friends;
console.log(userFriends === null || userFriends === void 0 ? void 0 : userFriends.map(friend => {
    return friend.name;
}).join(", "));
